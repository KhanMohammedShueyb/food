                ...
                <v-toolbar class="white" tile flat>
                    <v-row>
                        <v-col> <v-toolbar-title>
                                <h2 class="d-flex align-center"><v-icon class="px-2">mdi-truck</v-icon>User order details
                                </h2>
                            </v-toolbar-title>
                        </v-col>
...
export default class userordersdetail extends Vue {
    ...
    mounted(){
        ...
        axios.post("/api/orderDetail/show",obj).then((Response)=>{
