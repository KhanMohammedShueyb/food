<template>
  <section class="mt-3">
    <v-data-table show-select flat tile :search="search" :headers="headers" :items="data" sort-by="Code"
    ...
    <AddCategoryDialog v-if="dialog" :dialog="dialog" :selectedItem="selectedItem" :editedIndex="editedIndex"
      @close-dialog="close" />
  </section>
</template>
...
export default class categories extends Vue {
  @Action("categories/showCategory") show!: () => Promise<Array<Object>>
  @Action("categories/deleteCategory") delete!: (
    params: number
