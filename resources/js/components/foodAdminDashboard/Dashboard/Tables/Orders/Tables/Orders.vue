<template>
    <section class="mt-3">
        ...
        <v-data-table flat tile :search="search" :headers="headers" :items="data" sort-by="OrderID"
            class="elevation-1 table">
            <template v-slot:top>
                <v-toolbar class="white" tile flat>
                    <v-row>
                        <v-col> <v-toolbar-title>
                                <h2 class="d-flex align-center"><v-icon class="px-2">mdi-truck</v-icon> Orders
                                </h2>
                            </v-toolbar-title>
                        </v-col>
...
export default class orderss extends Vue {
    ...
    @Getter("orders/getOrders") getOrders: () => Promise<Array<Object>>;
    public search: any = ""
    public input: any = []
    public headers: Array<Object> = [
        ...
        { text: 'shipping_address', value: 'shipping_address' },
        { text: 'office_type', value: 'office_type' },
        { text: 'flat no', value: 'flat_no' },
        { text: 'street', value: 'street' },
        { text: 'city', value: 'city' },
        { text: 'zipcode', value: 'zipcode' },
        { text: 'contact_no', value: 'phno' },
        { text: 'total_price', value: 'totalprice' },
    ...
    mounted(){
        let obj: Object = this.getAuthUser;
        this.showOrder(obj).then((res:any) => {
