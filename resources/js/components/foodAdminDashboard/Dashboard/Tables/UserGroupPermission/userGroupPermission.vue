    ...
    <section >
        <v-card class="pa-3 borders" height="100vh" flat tile>
            <v-col class="d-flex justify-space-around px-0">
                <v-row>
                    <v-col><UserGrouppermission /></v-col>
                </v-row>
            </v-col>
        </v-card>
    </section>
...
import UserGrouppermission from './Tables/userGroupPermission.vue';
...
export default class UserGroupPermission extends Vue {
    ...
    mounted(){
        let permission: Object = this.getGroupPermissions[0]['group_permission']['user_group'];
