<template>
  <section class="mt-3">
            ...
            <v-col>
              <v-toolbar-title>
                <h2 class="d-flex align-center">
                  <v-icon class="px-2">mdi-view-list</v-icon>Products
                </h2>
              </v-toolbar-title>
            </v-col>
    ...
    <AddProductDialog v-if="dialog" :dialog="dialog" :selectedItem="selectedItem" :editedIndex="editedIndex"
      @close-dialog="close" />
  </section>
</template>
...
import AddProductDialog from "../Dialogs/AddProductsDialog.vue";
...
export default class products extends Vue {
  @Action("ProductStore/ShowProducts") show!: () => Promise<Array<Object>>
  @Action("ProductStore/deleteProducts") delete!: (
    params: number
  ...
  public headers: Array<Object> = [
    ...
    { text: "Item Group", value: "Item_Group" },
  ...
  mounted() {
    ...
    // this.$store.dispatch('ShowProducts').then(Response => {
    //   this.data = Response['Product'];
    // }); 
  }
}
