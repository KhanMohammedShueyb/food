    ...
    <v-dialog v-model="dialog" persistent max-width="500px">
        <v-card flat tile class="dialog">
            ...
            <v-col cols="12" sm="12" md="12">
                <v-text-field class="label-color" solo v-model="editedItem['title']" label="title"></v-text-field>
            </v-col>
            <v-col cols="12" sm="12" md="12">
            ...
            <v-col cols="12" sm="12" md="12">
                <v-text-field class="label-color" solo v-model="editedItem['condition']" label="condition"></v-text-field>
            </v-col>
            <v-col cols="12" sm="12" md="12">
                <v-text-field class="label-color" solo v-model="editedItem['discount']" label="discount"></v-text-field>
            </v-col>
